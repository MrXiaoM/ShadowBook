...
import top.mrxiaom.fix.book.utils.ColorHelper;
import top.mrxiaom.fix.book.utils.Util;
...
public abstract class AbstractPluginHolder {
    ...
    public final ShadowBookPlugin plugin;
    public AbstractPluginHolder(ShadowBookPlugin plugin) {
        this.plugin = plugin;
    }
